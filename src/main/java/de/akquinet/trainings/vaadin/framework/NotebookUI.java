...
import de.akquinet.trainings.vaadin.framework.views.home.HomeViewNavigation;
import de.akquinet.trainings.vaadin.framework.views.overview.OverviewViewNavigation;
...
public class NotebookUI extends UI
{
    ...
    @WebServlet(urlPatterns = "/*", name = "NotebookUIServlet", asyncSupported = true)
    @VaadinServletConfiguration(ui = NotebookUI.class, productionMode = false)
    public static class NotebookUIServlet extends VaadinCDIServlet
    {
    }
}
